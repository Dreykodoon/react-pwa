...
class History extends Component {
	constructor() {
		...
		History.getBTCPrices = History.getBTCPrices.bind(this);
		History.getETHPrices = History.getETHPrices.bind(this);
	...
	getTodayPrice() {
		...
		axios.all([History.getETHPrices(t), History.getBTCPrices(t), History.getLTCPrices(t)])
